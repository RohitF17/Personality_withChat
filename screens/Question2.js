...
export default function Question2({ navigation }) {
  ...
  const[question2,setquestion]=useState(null);
  ...
  function validationAnswer() {
    if (!question2.trim()) {
      ...
      GLOBAL.Question2=question2;
      console.log("globalVeriable",GLOBAL.Question2);
    ...
    return(
      ...
      <SafeAreaView style={styles.form}>
        ...
        <Text style={styles.bodyquestion}>What would your friend say about you and does it affect you? </Text>
         <TextInput
        style={styles.input}
